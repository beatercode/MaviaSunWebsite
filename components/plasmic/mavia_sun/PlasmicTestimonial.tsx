...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: eiUEUByxhG4rD/css
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column__phjqb)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column__fuEb0)}>
            <p.PlasmicImg
              ...
              src={{
                src: "/plasmic/mavia_sun/images/smalljpg.jpeg",
                fullWidth: 160,
                fullHeight: 160,
          ...
          <div className={classNames(projectcss.all, sty.column__dwxt7)}>
            <h5
