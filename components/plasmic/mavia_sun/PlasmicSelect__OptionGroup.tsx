...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: zSm-JUN5OUqScE/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 2_-2Pb2z0Dz8AC/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__uEw9H)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__uJlJ)}
              />
            </React.Fragment>
          ),
          value: args.children
