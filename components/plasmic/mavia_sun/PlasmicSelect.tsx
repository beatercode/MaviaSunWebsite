...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: 856NuP2C2v6FDF/component
import Select__Option from "../../Select__Option"; // plasmic-import: ek7Sa1QCHjTP_l/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_mavia_sun.module.css"; // plasmic-import: mJU3w7LiKHPBKUALsVD2dj/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: 2_-2Pb2z0Dz8AC/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: xTl1q2WjETbC-g/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: B3viFwcDwwy5ZZ/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__vtG4H)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__i5Wki)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
