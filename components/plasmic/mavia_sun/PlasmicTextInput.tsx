...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: ouQsDoISBjQ4g/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: KXR4GuP4o6y6tG/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__jpSoA)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__z2JWs)}
                role={"img"}
              />
            ),
